...
public interface IAuctionSearch
{
	 ...
	 * 
	 * @param query
	 *            The keyword phrase for the search.
	 * @param numResultsToSkip
	 *            The desired number of results to skip from the beginning of
	 *            the full results.
	 ...
	 *         representing the results of the query after skipping
	 *         numResultsToSkip SearchResult objects.
	 */
	 ...
	 * 
	 * @param constraints
	 *            An array of SearchConstraint objects representing the desired
	 *            query.
	 * @param numResultsToSkip
	 *            The desired number of results to skip from the beginning of
	 *            the full results.
	 ...
	 * 
	 * @param itemId
	 *            The ItemId of an item.
	 * @return A String of valid XML data (conforming to the original items.dtd)
	 *         containing data about the requested itemId. null is returned when
	 *         itemId is not valid.
	 */
