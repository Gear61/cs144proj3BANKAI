...
public class BasicBean
{
	 ...
	 * of the indexer The category will be a concatenation of all the categories
	 * the item is a part of ex: Item #1 is in 4 categories cat1, cat2, cat3,
	 * and cat4 category will hold "cat1 cat2 cat3 cat4" where each category
	 * will only be separated by spaces (category will be tokenized by lucene)
	 */
